...
export class PathBasedManager {
  ...
  static convertExportDataV2ToV1(dataV2: ExportDataV2): ExportDataV1 {
    ...
    // 转换代码片段
    const snippetsV1 = dataV2.snippets.map((snippet) => this.convertSnippetV2ToV1(snippet, emptyV1Directories))
   ...
   */
  static convertToV2(
    snippetsV1: CodeSnippetV1[],
    directoriesV1: DirectoryV1[]
  ): {
   ...
   */
  static convertToV1(
    snippetsV2: CodeSnippetV2[],
    directoriesV2: DirectoryV2[]
  ): {
    ...
    // 转换代码片段
    const snippetsV1 = snippetsV2.map((snippet) => this.convertSnippetV2ToV1(snippet, emptyV1Directories))
